...
CAPNP_DECLARE_SCHEMA(f5ac72480b267837);
CAPNP_DECLARE_SCHEMA(b47dba326915a437);
enum class ButtonControlState_b47dba326915a437: uint16_t {
  INACTIVE,
  LOADING,
  ACCELERATING,
  DECELERATING,
...
CAPNP_DECLARE_ENUM(ButtonControlState, b47dba326915a437);
...
struct CarControlSP::CustomStockLongitudinalControl {
  CustomStockLongitudinalControl() = delete;

  class Reader;
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::ButtonControlState_b47dba326915a437 ButtonControlState;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(f5ac72480b267837, 2, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline bool hasCustomStockLongitudinalControl() const;
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Reader getCustomStockLongitudinalControl() const;
...
public:
  ...
  inline bool hasCustomStockLongitudinalControl();
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Builder getCustomStockLongitudinalControl();
  inline void setCustomStockLongitudinalControl( ::cereal::CarControlSP::CustomStockLongitudinalControl::Reader value);
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Builder initCustomStockLongitudinalControl();
  inline void adoptCustomStockLongitudinalControl(::capnp::Orphan< ::cereal::CarControlSP::CustomStockLongitudinalControl>&& value);
  inline ::capnp::Orphan< ::cereal::CarControlSP::CustomStockLongitudinalControl> disownCustomStockLongitudinalControl();
...
public:
  ...
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Pipeline getCustomStockLongitudinalControl();
private:
  ::capnp::AnyPointer::Pipeline _typeless;
  friend class ::capnp::PipelineHook;
  template <typename, ::capnp::Kind>
...
class CarControlSP::CustomStockLongitudinalControl::Reader {
public:
  typedef CustomStockLongitudinalControl Reads;
  ...
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState getState() const;

  inline  ::int16_t getCruiseButton() const;

  inline float getFinalSpeedKphDEPRECATED() const;
...
class CarControlSP::CustomStockLongitudinalControl::Builder {
public:
  typedef CustomStockLongitudinalControl Builds;
  ...
  inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState getState();
  inline void setState( ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState value);

  inline  ::int16_t getCruiseButton();
  inline void setCruiseButton( ::int16_t value);

  inline float getFinalSpeedKphDEPRECATED();
  inline void setFinalSpeedKphDEPRECATED(float value);
...
#if !CAPNP_LITE
class CarControlSP::CustomStockLongitudinalControl::Pipeline {
public:
  typedef CustomStockLongitudinalControl Pipelines;
...
inline bool CarControlSP::Reader::hasCustomStockLongitudinalControl() const {
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool CarControlSP::Builder::hasCustomStockLongitudinalControl() {
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Reader CarControlSP::Reader::getCustomStockLongitudinalControl() const {
  return ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Builder CarControlSP::Builder::getCustomStockLongitudinalControl() {
  return ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
#if !CAPNP_LITE
inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Pipeline CarControlSP::Pipeline::getCustomStockLongitudinalControl() {
  return  ::cereal::CarControlSP::CustomStockLongitudinalControl::Pipeline(_typeless.getPointerField(0));
}
#endif  // !CAPNP_LITE
inline void CarControlSP::Builder::setCustomStockLongitudinalControl( ::cereal::CarControlSP::CustomStockLongitudinalControl::Reader value) {
  ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::Builder CarControlSP::Builder::initCustomStockLongitudinalControl() {
  return ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void CarControlSP::Builder::adoptCustomStockLongitudinalControl(
    ::capnp::Orphan< ::cereal::CarControlSP::CustomStockLongitudinalControl>&& value) {
  ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::cereal::CarControlSP::CustomStockLongitudinalControl> CarControlSP::Builder::disownCustomStockLongitudinalControl() {
  return ::capnp::_::PointerHelpers< ::cereal::CarControlSP::CustomStockLongitudinalControl>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}

inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState CarControlSP::CustomStockLongitudinalControl::Reader::getState() const {
  return _reader.getDataField< ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline  ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState CarControlSP::CustomStockLongitudinalControl::Builder::getState() {
  return _builder.getDataField< ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::CustomStockLongitudinalControl::Builder::setState( ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState value) {
  _builder.setDataField< ::cereal::CarControlSP::CustomStockLongitudinalControl::ButtonControlState>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}

inline  ::int16_t CarControlSP::CustomStockLongitudinalControl::Reader::getCruiseButton() const {
  return _reader.getDataField< ::int16_t>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}

inline  ::int16_t CarControlSP::CustomStockLongitudinalControl::Builder::getCruiseButton() {
  return _builder.getDataField< ::int16_t>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::CustomStockLongitudinalControl::Builder::setCruiseButton( ::int16_t value) {
  _builder.setDataField< ::int16_t>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, value);
}

inline float CarControlSP::CustomStockLongitudinalControl::Reader::getFinalSpeedKphDEPRECATED() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}

inline float CarControlSP::CustomStockLongitudinalControl::Builder::getFinalSpeedKphDEPRECATED() {
  return _builder.getDataField<float>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::CustomStockLongitudinalControl::Builder::setFinalSpeedKphDEPRECATED(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, value);
}

inline float CarControlSP::CustomStockLongitudinalControl::Reader::getVTarget() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<2>() * ::capnp::ELEMENTS);
}

inline float CarControlSP::CustomStockLongitudinalControl::Builder::getVTarget() {
  return _builder.getDataField<float>(
      ::capnp::bounded<2>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::CustomStockLongitudinalControl::Builder::setVTarget(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<2>() * ::capnp::ELEMENTS, value);
}

inline float CarControlSP::CustomStockLongitudinalControl::Reader::getVCruiseCluster() const {
  return _reader.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS);
}

inline float CarControlSP::CustomStockLongitudinalControl::Builder::getVCruiseCluster() {
  return _builder.getDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS);
}
inline void CarControlSP::CustomStockLongitudinalControl::Builder::setVCruiseCluster(float value) {
  _builder.setDataField<float>(
      ::capnp::bounded<3>() * ::capnp::ELEMENTS, value);
}
